...
*/
define('simple_feed_list_version','2.3.2');
...
function get_feed_code($feed_url,$list_limit="20",$desc_flag="",$more="",$target="_blank",$nofollow="",$title_len="",$cache="1",$source="fun") {  
    ...
    if ($check_failure!==true) {
        ...
        if ($array=="") {
            ...
            if (($list_limit!=1)&&($source="sc")) {$code.="<ul class=\"feed_list\">\n";}
            ...
            foreach ($items as $item) {
                ...
                if ($list_limit!=1) {$code.="<li class=\"feed_list\">";}
                if ($link!="") {$code.="<a href=\"".$link."\" target=\"".$target."\"".$nofollow." class=\"feed_list\">";}
            ...
            if (($list_link!="")&&($more!="no")&&($list_limit!=1)) {$code.="<li><a href=\"".$list_link."\" target=\"".$target."\"".$nofollow." class=\"feed_list\">".__('More')."...</a></li>\n";}
