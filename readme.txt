...
To display a feed on your WordPress site you will need to insert the following code, where appropriate, into your theme…
...
`<?php if (function_exists('simple_feed_list2')) : ?>`
`<h2>Latest Apple Movie Trailers</h2>`
`<ul><?php simple_feed_list2('http://images.apple.com/trailers/home/rss/newtrailers.rss','limit=5'); ?></ul>`
`<?php endif; ?>`
